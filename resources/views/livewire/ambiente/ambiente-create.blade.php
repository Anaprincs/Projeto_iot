<div class="container mt-5">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <h2 class="text-center mb-4" style="font-family: 'Arial', sans-serif; color: #c11111; font-weight: bold;">
                Cadastro
            </h2>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="store">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="codigo" wire:model.defer="nome" class="form-control">
                            @error('ambiente_id')
                        ...
                        <a href="{{ route('ambiente.index') }}"><input class="btn btn-success" type="submit"
                                value="Cadastrar"></a>
